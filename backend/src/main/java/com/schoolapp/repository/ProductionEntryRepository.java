...
public interface ProductionEntryRepository extends JpaRepository<ProductionEntry, Long> {
    ...
    java.util.List<ProductionEntry> findByCreatedDateBetweenAndPlantName(java.util.Date start,
            String plantName);
    java.util.List<ProductionEntry> findByCreatedDateBetweenAndPlantNameIn(java.util.Date start,
